...
public class OssuaryModel extends GeoModel<OssuaryBlockEntity> {
    ...
    public ResourceLocation getAnimationResource(OssuaryBlockEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(Graveyard.MOD_ID,"animations/ossuary/ossuary.animation.json");
    }

    @Override
    public ResourceLocation getModelResource(OssuaryBlockEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Graveyard.MOD_ID, "geo/ossuary.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(OssuaryBlockEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(Graveyard.MOD_ID, "textures/block/ossuary.png");
    }
}
