...
public class NamelessHangedModel extends GeoModel<NamelessHangedEntity> {
    ...
    public ResourceLocation getModelResource(NamelessHangedEntity object) {
        return ResourceLocation.fromNamespaceAndPath(Graveyard.MOD_ID, "geo/nameless_hanged.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(NamelessHangedEntity object) {
        return ResourceLocation.fromNamespaceAndPath(Graveyard.MOD_ID,"textures/entity/nameless_hanged.png");
    }

    @Override
    public ResourceLocation getAnimationResource(NamelessHangedEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Graveyard.MOD_ID, "animations/nameless_hanged/nameless_hanged.animation.json");
    }
}
