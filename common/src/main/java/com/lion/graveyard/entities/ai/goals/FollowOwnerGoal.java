...
public class FollowOwnerGoal extends Goal {
    ...
    private boolean canTeleportTo(BlockPos p_25308_) {
        PathfindingContext pathfindingcontext = new PathfindingContext(this.level, tamable);
        PathType blockpathtypes = WalkNodeEvaluator.getPathTypeStatic(pathfindingcontext, p_25308_.mutable());
